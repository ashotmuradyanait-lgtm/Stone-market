...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-4">
  ...
  <div className="text-center">
    <img className="h-[180px] w-[250px] rounded-lg mx-auto" src="https://www.stonemarket.am/_next/image?url=https%3A%2F%2Fapi.stonemarket.am%2F1741863888966--Logo_16x10.webp&w=1920&q=75" alt=""/>
...
<div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-4">
    <div className="text-center bg-white rounded-lg p-4">
      <img className="h-[180px] w-[250px] rounded-lg mx-auto" src="https://www.stonemarket.am/_next/image?url=https%3A%2F%2Fapi.stonemarket.am%2F1743496374536--photo_2025-04-01_12-07-17_(3).webp&w=1920&q=75" alt=""/>
      <p className="font-semibold mt-2">«Archimikanika» արվեստանոց</p>
      <p className="text-sm">«Archimikanika» արվեստանոցը <br /> հիմնադրվել է 2013թ.-ին ճարտարապետ․․․</p>
    </div>

    <div className="text-center bg-white rounded-lg p-4">
      <img className="h-[180px] w-[250px] rounded-lg mx-auto" src="https://www.stonemarket.am/_next/image?url=https%3A%2F%2Fapi.stonemarket.am%2F1743515286102--530DE1F7-D095-4A8B-BBC0-64BA3DFA4C6F%5B1%5D.webp&w=1920&q=75" alt=""/>
      <p className="font-semibold mt-2">EIMI DESIGN CONSTRUCTION</p>
      <p className="text-sm">Նախգծում ենք տարբեր տեսակի <br /> տարածքներ՝...</p>
    </div>

    <div className="text-center bg-white rounded-lg p-4 ">
      <img className="h-[180px] w-[250px] rounded-lg mx-auto" src="https://www.stonemarket.am/_next/image?url=https%3A%2F%2Fapi.stonemarket.am%2F1745225933703--WhatsApp_Image_2025-04-21_at_12.34.35_3c21b472.webp&w=1920&q=75" alt=""/>
      <p className="font-semibold mt-2">UPROject</p>
      <p className="text-sm">Ճարտարապետություն, ինտերիերի դիզայն, <br /> գրաֆիկ դիզայն...</p>
    </div>

    <div className="text-center bg-white rounded-lg p-4">
      <img className="h-[180px] w-[250px] rounded-lg mx-auto" src="https://www.stonemarket.am/_next/image?url=https%3A%2F%2Fapi.stonemarket.am%2F1745317648399--WhatsApp_Image_2025-02-24_at_14.49.41_c7e30489.webp&w=1920&q=75" alt=""/>
      <p className="font-semibold mt-2">Ակկուռատ Գրուպ ՍՊԸ</p>
      <p className="text-sm">«Ակկուռատ Գրուպ» ընկերությունը <br /> հիմնադրվել է 2002թ.-ին...</p>
    </div>
  </div>

  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-4">
    <div className="text-center bg-white rounded-lg p-4">
      <img className="h-[180px] w-[250px] rounded-lg mx-auto" src="https://www.stonemarket.am/_next/image?url=https%3A%2F%2Fapi.stonemarket.am%2F1745933324974--WhatsApp_Image_2025-04-29_at_15.34.50_8c599435.webp&w=1920&q=75" alt=""/>
      <p className="font-semibold mt-2">Ատրիում ճարտարապետական․․․</p>
      <p className="text-sm">Ատրիում ճարտարապետական <br /> արվեստանոցը հիմնադրվել է 2006 թ․-ին․․․</p>
    </div>
  </div>
</div>
</>
